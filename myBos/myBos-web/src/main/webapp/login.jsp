		...
		<div id="loginBlock" class="login"
			...
			<div class="loginFunc">
				<div id="lbNormal" class="loginFuncMobile">员工登录</div>
					...
					<div style="text-align:center;color:red"><s:actionerror></s:actionerror></div>
			<div class="loginForm">
				<form id="loginform" name="loginform" method="post" class="niceform"
					...
					<div id="idInputLine" class="loginFormIpt showPlaceholder"
						...
						<input id="loginform:idInput" type="text" name="email"
							class="loginFormTdIpt easyui-validatebox" maxlength="50" data-options="required:true,validType:'email'"/>
					...
					<div id="pwdInputLine" class="loginFormIpt showPlaceholder">
						<input id="loginform:pwdInput" class="loginFormTdIpt easyui-validatebox" type="password"
							name="password"  data-options="required:true,validType:'length[5,10]'"/>
					...
					<div class="loginFormIpt loginFormIptWiotTh"
						...
						<a href="javascript:void(0);" id="loginform:j_id19" name="loginform:j_id19" onclick="_submit()">
						<span
