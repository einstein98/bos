 ...
 * Generated at: 2017-08-15 01:13:57 UTC
...
public final class decidedzone_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("\tvar decidedZoneId;\r\n");
      out.write("\tfunction doAdd(){\r\n");
      out.write("\t\t$('#updateDecidedzoneWindow').window(\"open\");\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t$(\"#associationSelect option:enabled\").remove();\r\n");
      out.write("\t\t$('#noassociationSelect option:enabled').remove();\r\n");
      out.write("\t\tvar selected = $('#grid').datagrid('getSelected');\r\n");
      out.write("\t\tif(selected==null) {\r\n");
      out.write("\t\t\t$.messager.alert('错误','请先选择定区','error');\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t$('#customerWindow').window('open');\r\n");
      out.write("\t\t$.post('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedzone_getAssociatedCust.action',{id:selected.id},function(data) {\r\n");
      ...
      out.write("\t\t$.post('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedzone_getNoAssociatedCust.action',{id:selected.id},function(data) {\r\n");
      out.write("\t\t\t$(data).each(function() {\r\n");
      ...
      out.write("\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedzone_getPage.action\",\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t// 添加、修改定区\r\n");
      out.write("\t\t$('#updateDecidedzoneWindow').window({\r\n");
      ...
      out.write("\t\t\t$('#grid').datagrid('load',$('#searchDecidedzoneForm').serializeJson());\r\n");
      out.write("\t\t\t$('#searchWindow').window('close');\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$('#save').click(function() {\r\n");
      out.write("\t\t\tif($('#updateDecidedzoneForm').form('validate')) {\r\n");
      out.write("\t\t\t\t$('#updateDecidedzoneForm').ajaxSubmit(function() {\r\n");
      out.write("\t\t\t\t\t$.messager.alert('成功','数据更新成功','info');\r\n");
      ...
      out.write("\t\t\tdecidedZoneId: { \r\n");
      out.write("\t\t\t\tvalidator: function(value, param){ \r\n");
      out.write("\t\t\t\t\tvar flag;\r\n");
      out.write("\t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\tasync:false,\r\n");
      out.write("\t\t\t\t\t\tdata:{\r\n");
      out.write("\t\t\t\t\t\t\tnewId:value,\r\n");
      out.write("\t\t\t\t\t\t\toldId:decidedZoneId\r\n");
      out.write("\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\turl:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedZone_checkId.action',\r\n");
      out.write("\t\t\t\t\t\ttype:'POST',\r\n");
      ...
      out.write("\t\t}) \r\n");
      out.write("\t\t$(\"#allToRight\").click(function(){\r\n");
      out.write("\t\t\t$('#associationSelect').append($('#noassociationSelect option:enabled'));\r\n");
      out.write("\t\t}) \r\n");
      out.write("\t\t$(\"#allToLeft\").click(function(){\r\n");
      out.write("\t\t\t$('#noassociationSelect').append($('#associationSelect option:enabled'));\r\n");
      out.write("\t\t}) \r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$('#associationBtn').click(function() {\r\n");
      out.write("\t\t\t$('#associationSelect option:enabled').attr(\"selected\",\"selected\");\r\n");
      out.write("\t\t\t$('#customerDecidedZoneId').val($('#grid').datagrid('getSelected').id)\r\n");
      out.write("\t\t\t$('#customerForm').ajaxSubmit();\r\n");
      ...
      out.write("\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/subarea_getSubareaByDecidedzoneId.action?decidedZone.id=\" +rowData.id,\r\n");
      out.write("\t\t\tcolumns : [ [{\r\n");
      out.write("\t\t\t\tfield : 'id',\r\n");
      ...
      out.write("\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedzone_getAssociatedCust.action?id=\"+rowData.id,\r\n");
      out.write("\t\t\tcolumns : [[{\r\n");
      out.write("\t\t\t\tfield : 'id',\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t<!-- 添加 修改分区 -->\r\n");
      out.write("\t<div class=\"easyui-window\" title=\"定区添加修改\" id=\"updateDecidedzoneWindow\" collapsible=\"false\" minimizable=\"false\" maximizable=\"false\" style=\"top:20px;left:200px\">\r\n");
      ...
      out.write("\t\t\t<form id=\"updateDecidedzoneForm\" action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedZone_updateDecidedZone\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"id\" class=\"easyui-validatebox\" required=\"true\" data-options=\"validType:'decidedZoneId'\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/subarea_getSubareaList',fitColumns:true,singleSelect:false\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<thead>  \r\n");
      out.write("\t\t\t\t\t\t\t        <tr>  \r\n");
      ...
      out.write("\t\t<div style=\"overflow:auto;padding:5px;\" border=\"false\">\r\n");
      out.write("\t\t\t<form id=\"searchDecidedzoneForm\">\r\n");
      out.write("\t\t\t\t<table class=\"table-edit\" width=\"80%\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t<tr class=\"title\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"radio\" name=\"hasDecidedzone\" value=\"1\"/>是\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"radio\" name=\"hasDecidedzone\" value=\"2\"/>否\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/decidedzone_setCustomersToDecidedzone\" method=\"post\">\r\n");
      out.write("\t\t\t\t<table class=\"table-edit\" width=\"80%\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t<tr class=\"title\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<option disabled=\"disabled\">未关联定区用户</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"button\" value=\"--》\" id=\"toRight\"><br/>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"button\" value=\"---》\" id=\"allToRight\"><br/>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"button\" value=\"《---\" id=\"allToLeft\"><br/>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<option disabled=\"disabled\">本定区关联用户</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"3\"><a id=\"associationBtn\" href=\"javascript:void(0);\" class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-save'\">关联客户</a> </td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
