 ...
 * Generated at: 2017-08-15 01:13:28 UTC
...
public final class standard_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/standard_getPage.action\",\r\n");
      out.write("\t\t\t\t\tidField : 'id',\r\n");
      out.write("\t\t\t\t\tcolumns : columns,\r\n");
      out.write("\t\t\t\t\tonDblClickRow : onDblClickRow\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t// 添加取派员窗口\r\n");
      out.write("\t\t\t\t$('#updateStandardWindow').window({\r\n");
      ...
      out.write("\t\t\t\t\t$('#updateStandardForm').ajaxSubmit(function(){\r\n");
      out.write("\t\t\t\t\t\t$('#updateStandardWindow').window('close');\r\n");
      ...
      out.write("\t\t\t\t\t$('#updateStandardWindow').window(\"open\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}, {\r\n");
      ...
      out.write("\t\t\t\t\t}else {\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t$('#updateStandardForm').form('load',selections[0]);\r\n");
      out.write("\t\t\t\t\t\t$('#updateStandardWindow').window(\"open\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t},{\r\n");
      ...
      out.write("\t\t\t\t\t\t$.post('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/standard_batchDelete.action',{ids:idStr},function() {\r\n");
      ...
      out.write("\t\t\t\t\t\t$.post('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/standard_batchRevert.action',{ids:idStr},function() {\r\n");
      ...
      out.write("\t\t\t} ] ];\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tfunction onDblClickRow(rowIndex,rowData) {\r\n");
      out.write("\t\t\t\t$('#updateStandardForm').form('load',rowData);\r\n");
      out.write("\t\t\t\t$('#updateStandardWindow').window(\"open\");\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t</script>\r\n");
      out.write("\t</head>\r\n");
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t\t<!-- 添加取派员窗体  -->\r\n");
      out.write("\t<div class=\"easyui-window\" title=\"对收派员进行添加或者修改\" id=\"updateStandardWindow\" collapsible=\"false\" minimizable=\"false\" maximizable=\"false\" style=\"top:20px;left:200px\">\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/standard_updateStandard\">\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"minweight\" class=\"easyui-validatebox easyui-numberbox\" required=\"true\" data-options=\"min:1,precision:0,suffix:'KG'\"/>\r\n");
      out.write("\t\t\t\t\t\t   </td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>最大重量</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"maxweight\" class=\"easyui-validatebox easyui-numberbox\" required=\"true\" data-options=\"min:1,precision:0,suffix:'KG'\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>最小长度</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"minlength\" class=\"easyui-validatebox easyui-numberbox\" required=\"true\" data-options=\"min:1,precision:0,suffix:'CM'\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>最大长度</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"maxlength\" class=\"easyui-validatebox easyui-numberbox\" required=\"true\" data-options=\"min:1,precision:0,suffix:'CM'\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
